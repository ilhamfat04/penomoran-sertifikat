                        ...
                        <div class="modal fade" id="modal<?= $nmr->id  ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    $detail_terbit = $this->db->select('id_kegiatan,tgl_terbit')->where('id_pengajuan', $nmr->id)->get('detail_penerbitan')->row();

                                    if ($detail_terbit) {
                                        $id_kegiatan = intval($detail_terbit->id_kegiatan);
                                    }
                                    ...
                                    <form action="<?php echo base_url() . 'admin/terbit'; ?>" method="post">
                                        <div class="modal-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="tanggal_terbit" name="tanggal_terbit" value="<?php if ($detail_terbit) {
                                                                                                                                                    echo $detail_terbit->tgl_terbit;
                                                                                                                                                } else {
                                                                                                                                                    echo date("d-M-Y");
                                                                                                                                                } ?>" readonly>
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="form-control" id="jenis" name="jenis">
                                                        <?php foreach ($jenis as $jn) : ?>
                                                            <option value="<?= $jn['id'] ?>" <?php if ($jn['id'] == $id_kegiatan) {
                                                                                                    echo "selected";
                                                                                                } ?>>
                                                                <?= $jn['jenis_kegiatan'] ?>
                                                            </option>
