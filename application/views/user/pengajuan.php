    ...
    <div class="col-lg-10">
        ...
        <form action="tambah_pengajuan" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label for="penyelenggara" class="col-sm-4 col-form-label">Nama Penyelenggara<b>*</b></label>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <label for="nama_kegiatan" class="col-sm-4 col-form-label">Nama Kegiatan<b>*</b></label>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <label for="tanggal_kegiatan" class="col-sm-4 col-form-label">Tanggal Kegiatan<b>*</b></label>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <label for="pihak_satu" class="col-sm-4 col-form-label">Pihak Menandatangani (1)<b>*</b></label>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <label for="jabatan_pihak_satu" class="col-sm-4 col-form-label">Jabatan Pihak Menandatangani (1)<b>*</b></label>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <label for="penerima" class="col-sm-4 col-form-label">Daftar Penerima (excel)<b>*</b></label>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <label for="desain" class="col-sm-4 col-form-label">Desain Sertifikat (jpg/png)<b>*</b></label>
                <div class="col-sm-8">
                    <div class="custom-file">
            ...
            <?php if ($user['kode_penyelenggara']  == 5 || $user['kode_penyelenggara'] == 6) { ?>
                ...
                <div class="form-group row">
                    <label for="scan_formulir" class="col-sm-4 col-form-label">Formulir Ditandatangani (pdf)<b>*</b></label>
                    <div class="col-sm-8">
                        <div class="custom-file">
