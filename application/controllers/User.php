...
class User extends CI_Controller
{
    ...
    public function tambah_pengajuan()
    {
        ...
        } elseif ($pihak_satu == $pihak_dua or $pihak_satu == $pihak_tiga or $pihak_dua == $pihak_tiga) {
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Terdapat Pihak Menandatangani Ganda</div>');
            redirect('user/pengajuan');
        } elseif ($jabatan_pihak_satu == $jabatan_pihak_dua or $jabatan_pihak_satu == $jabatan_pihak_tiga or $jabatan_pihak_dua == $jabatan_pihak_tiga) {
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Terdapat Jabatan Pihak Menandatangani Ganda</div>');
            redirect('user/pengajuan');
        } else {
    ...
    public function konversi($id)
    {
        ...
        $pengajuan = $this->db->where('id_pengajuan', $id)->from('detail_penerima')->count_all_results();
    ...
    public function excel($id)
    {
       $data_penerima = $this->db->where('id_pengajuan', $id)->get('detail_penerima')->result();
        ...
        $protection->setPassword('pusdiklat-uty-hebat');
